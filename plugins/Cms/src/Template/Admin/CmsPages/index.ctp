...
<div id="page-wrapper">
	...
	<div class="row">
		<div class="col-lg-12">
			<div class="col-lg-6">
				<h1 class="page-header">Cms Page List</h1>
			</div>
			<div class="col-lg-6">
				<?php echo $this->Html->link('Add News',array('action' => 'add'),array('class' => 'btn btn-primary','style' => array('float: right; margin-top: 58px;'))); ?>
			</div>
		</div>
		<!-- /.col-lg-12 -->
	</div>
				...
				<div class="panel-body">
					<div class="table-responsive1">
						...
						<table class="table table-striped table-bordered table-hover">
							<thead>
								<tr>
									<th  class="td-head"width="25%"><?php echo $this->Paginator->sort('title','Title'); ?></th>
									<th  class="td-head"width="40%"><?php echo $this->Paginator->sort('description','Description'); ?></th>
