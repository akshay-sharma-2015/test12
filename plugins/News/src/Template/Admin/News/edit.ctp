		...
		<?php } ?>
			<div class="col-lg-12">
				<div class="form-group">
					...
					if(!empty($newsPage->image) && file_exists(NEWS_IMG_ROOT_PATH.$newsPage->image)){ ?>
						<img height="200" width="200" src="<?php echo WEBSITE_UPLOADS_URL.'image.php?width=200px&height=200px&cropratio=1:1&image='.NEWS_IMG_URL.$newsPage->image; ?>" />
					<?php  } ?>
				</div>
			</div>
			<div class="col-lg-12">				
