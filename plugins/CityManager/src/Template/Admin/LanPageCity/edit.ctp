...
<div class="row">
	...
	<div class="row">
		<div class="col-lg-6">
			<h1 class="page-header">Update casino image</h1>
		</div>
		<div class="col-lg-6">
						...
						<div class="col-lg-12" ng-app="plunker"  ng-controller="MainCtrl">
							<?php echo $this->Form->create($lanPageCity,array('type' => 'file','novalidate' => true)); ?>
								<div class="form-group">
									...
									<?php echo $this->Form->text("city_id1",array('class' => 'form-control autocomplete','placeholder' => 'Search Any Casino','required' => true,'value' => $lanPageCity->city->title));  ?>   
								...
								<div class="form-group">
									...
									<?php echo $this->Form->file("image",['required' => true]);
									 if((GALLERY_ROOT_PATH.$lanPageCity->image)){
										echo $this->Html->image(WEBSITE_UPLOADS_URL.'image.php?width=100px&height=100px&cropratio=1:1&image='.GALLERY_IMG_URL.$lanPageCity->image);
									 }
