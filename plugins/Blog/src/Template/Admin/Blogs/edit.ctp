...
<div id="page-wrapper" style="min-height: 140px;">
	...
	<div class="panel-body">	
		...
		<?php echo $this->Form->create($blogPage,array('role' => 'form','type' => 'file')); ?>			
			<div class="tab-content">
				...
				<div class="col-lg-12">			
					<div class="form-group">
						<label>Blog By</label>
						<?php  echo $this->Form->select("blogs_user",$blogs_user,array('class' => 'form-control'));
						echo ($lanagauage->is_default == 1) ? $this->Form->error("blogs_user") : ''; ?>
					</div>	
				</div>
		...
		<?php } ?>
			<div class="col-lg-12">
				<div class="form-group">
					...
					if(!empty($blogPage->image) && file_exists(BLOG_IMG_ROOT_PATH.$blogPage->image)){ ?>
						<img height="200" width="200" src="<?php echo WEBSITE_UPLOADS_URL.'image.php?width=200px&height=200px&cropratio=1:1&image='.BLOG_IMG_URL.$blogPage->image; ?>" />
					<?php  } ?>
				</div>
			</div>
			<div class="col-lg-12">				
