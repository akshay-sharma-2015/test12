			...
			<?php } ?>			
				<div class="col-lg-12">
					<div class="form-group">
						...
						<?php 
						if((SLIDER_ROOT_PATH.$slider->image)){
							echo $this->Html->image(WEBSITE_UPLOADS_URL.'image.php?width=100px&height=100px&cropratio=1:1&image='.SLIDER_IMG_URL.$slider->image);
						} ?>
					</div>
				</div>
				<div class="col-lg-12">
